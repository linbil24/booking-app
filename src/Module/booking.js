...
const Booking = () => {
    ...
    const [bookings, setBookings] = useState([
        { id: 'BK-001', student: 'Juan Dela Cruz', type: 'TDC', branch: 'Lipa Branch', date: '2024-03-20', time: '08:00 AM - 12:00 PM', status: 'Pending', amount: 'P 2,500', payment: 'GCash' },
        { id: 'BK-002', student: 'Maria Santos', type: 'PDC', branch: 'Batangas Branch', date: '2024-03-21', time: '01:00 PM - 03:00 PM', status: 'Confirmed', amount: 'P 5,000', payment: 'Cash' },
        { id: 'BK-003', student: 'Jose Rizal', type: 'TDC', branch: 'Tanauan Branch', date: '2024-03-22', time: '08:00 AM - 12:00 PM', status: 'Pending', amount: 'P 2,500', payment: 'PayMaya' },
        { id: 'BK-004', student: 'Andres Bonifacio', type: 'PDC', branch: 'Lipa Branch', date: '2024-03-23', time: '10:00 AM - 12:00 PM', status: 'Cancelled', amount: 'P 4,500', payment: 'GCash' },
        { id: 'BK-005', student: 'Emilio Aguinaldo', type: 'TDC', branch: 'Lipa Branch', date: '2024-03-24', time: '01:00 PM - 05:00 PM', status: 'Confirmed', amount: 'P 2,500', payment: 'Bank Transfer' },
    ]);
                    ...
                    <div className="modal-container user-modal" style={{ maxWidth: '500px' }}>
                        ...
                        <div className="modal-body" style={{ padding: '25px' }}>
                            ...
                            <div className="detail-field" style={{ marginTop: '20px', padding: '15px', background: '#f8fafc', borderRadius: '12px' }}>
                                <label style={{ display: 'block', fontSize: '0.75rem', color: '#94a3b8', textTransform: 'uppercase', marginBottom: '4px' }}>Payment Reference</label>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <span style={{ fontWeight: '600', color: '#334155' }}>{selectedBooking.payment} (Transaction ID: 9283741)</span>
                                ...
                                <tr key={booking.id}>
                                    ...
                                    <td className="bk-payment">
                                        <div className="payment-info">
                                            ...
                                            <span className="method">{booking.payment}</span>
                                        </div>
                                    </td>
                                    <td>

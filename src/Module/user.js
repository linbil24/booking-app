                    ...
                    {filteredUsers.map(user => (
                        <div key={user.id} className="user-card">
                            <div className="user-card-header">
                                <div className="user-avatar" onClick={() => handleViewUser(user)} style={{ cursor: 'pointer' }}>
                                    {user.avatar ? (
                            ...
                            <div className="user-card-body">
                                ...
                                <div className="user-info-row">
                                    ...
                                    <span className="branch-info">{user.branch}</span>
                                </div>
                            </div>
                            <div className="user-card-footer">
                                <span className="last-login">Last login: {user.lastLogin}</span>
                                <div className="card-actions">
                                    <button className="view-user" title="View Details" onClick={() => handleViewUser(user)}>
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                                    </button>
                                    <button className="edit-user" title="Edit User" onClick={() => handleEditClick(user)}>
                                    ...
                                    <button
                                        className={`toggle-user ${user.status === 'Active' ? 'deactivate' : 'activate'}`}
